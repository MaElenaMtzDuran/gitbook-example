...
1. La instalación de Node.js y [HonKit](https://github.com/honkit/honkit) en el runner de GitHub Actions.
2. La generación del sitio HTML (`honkit build`), el PDF y el EPUB.
